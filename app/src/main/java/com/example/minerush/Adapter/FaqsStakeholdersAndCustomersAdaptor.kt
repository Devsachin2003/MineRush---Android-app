...
class FaqsStakeholdersAndCustomersAdaptor(private val userList: ArrayList<FaqsData>) : RecyclerView.Adapter<FaqsStakeholdersAndCustomersAdaptor.UsersViewHolder>() {
